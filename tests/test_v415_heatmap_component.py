...
def test_heatmap_grid_is_fine_and_compact() -> None:
    ...
    # left gutter — was 200 (oversized), then 96 (founder-tight), 124
    # (iter #17), and now 156 (iter #54): the wider gutter plus
    # word-aware truncation keeps prose future names legible without
    # re-ballooning the grid cells.
    assert "PADX_L = 156" in html
