...
TRANSLATIONS: Final[dict[str, dict[str, str]]] = {
    ...
    "settings.personalization.desc": {
        LANG_EN: "A display name and a standing context the model reuses, plus the readout tone.",
        LANG_ZH: "显示名称、模型可复用的固定背景信息，以及解读的语气。",
        LANG_ES: "Un nombre visible, un contexto permanente que el modelo reutiliza y el tono de lectura.",
        LANG_FR: "Un nom affiché, un contexte permanent réutilisé par le modèle et le ton de lecture.",
    },
    "settings.data.desc": {
